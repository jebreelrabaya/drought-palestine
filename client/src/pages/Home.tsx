    ...
    <main className="min-h-screen overflow-hidden bg-[#f5f8f4] text-slate-800" dir="rtl">
      ...
      <section id="المصدر" className="border-y border-[#dce9e2] bg-[#eaf4ef]">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-14 sm:px-8 lg:grid-cols-[.8fr_1.2fr] lg:px-10">
          ...
          <div className="space-y-4 text-sm leading-8 text-slate-600"><p>يعتمد هذا الإصدار على تقديرات الهطول من <strong className="font-semibold text-slate-800">CHIRPS v3.0</strong> الصادرة عن مركز مخاطر المناخ في جامعة كاليفورنيا – سانتا باربرا، وتُقرأ عند إحداثيات مركز المدينة المختارة بدقة 0.05 درجة. تُؤخذ المجاميع الشهرية مباشرة من مرئيات CHIRPS الشهرية، ثم تُجمع لإنشاء إجماليات الموسم المطري الفلسطيني من آب حتى أيار. أما القيَم اليومية فتُستخرج من سلسلة CHIRPS اليومية، حيث يوزَّع مجموع البنتاد على أيامه اعتمادًا على بيانات ERA5. لا تُعرض القيمة الناقصة أو غير الصالحة من المصدر.</p><p>الأولوية دائمًا لـ <a className="font-semibold text-[#0b7067] underline decoration-[#7fc4ad] underline-offset-4" href="https://www.chc.ucsb.edu/data/chirps" target="_blank" rel="noreferrer">CHIRPS</a>: يُستخدم الإصدار الثالث أولًا، وإذا تعذّر الوصول إليه لفترة ما يعود التطبيق إلى <strong className="font-semibold text-slate-800">CHIRPS v2.0</strong>. وفي الحالات التي لا يغطيها CHIRPS إطلاقًا — وأبرزها أريحا، إذ تقع خليتها ضمن القناع المائي لأخدود البحر الميت في شبكة الإصدار الثاني — يُلجأ إلى <strong className="font-semibold text-slate-800">NASA POWER</strong> كمصدر أخير. يُصرَّح بالمصدر الفعلي لكل عرض في حقل «المصدر» وفي ورقة المنهجية داخل ملف التصدير، فلا تُنسب أي قراءة إلى CHIRPS ما لم تأتِ منه فعلًا.</p></div>
        </div>
      </section>

      <footer className="bg-[#083834] px-5 py-8 text-center text-sm text-emerald-100/75 sm:px-8"><p>مستكشف أمطار فلسطين — منصة استكشافية لبيانات الأمطار التاريخية.</p><p className="mt-2 text-xs">CHIRPS v3.0 هو المصدر الأساسي، ثم CHIRPS v2.0، ولا يُستخدم NASA POWER إلا حيث لا يغطي CHIRPS. المصدر الفعلي مذكور مع كل عرض.</p></footer>
    </main>
  );
}
